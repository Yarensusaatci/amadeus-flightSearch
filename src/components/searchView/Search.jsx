      ...
      <div className="search__box">
        ...
        <InputSearch id='is2' listName='apts' onClick={this.inputSearchClickHandlerDestination}/>
          ...
          <div className="passengers">            
            <span className="passenger__count">GUEST: {this.state.passengers} </span>            
          ...
          <button className="form__submit" type="submit" onClick={this.onSearchSubmit}>Search Flights</button>
