      ...
      <div className="flight" ref="flightRef">
        ...
        <div className="flight__details">
          <div className="flight__timings">
              ...
              <h2 className="flight__number">{this.props.FlightData.airline}</h2>
              <h3 className="flight__number">{this.props.FlightData.number.toUpperCase()}</h3>
              ...
              <p className="flight__depart__time">Departure time: {flight.depart_time}</p>
              <p className="flight__arrive__time">Arrival time: {flight.arrive_time}</p>
              <p className="flight__number">{this.props.FlightData.price} TL</p>
            </div>
             { 
              this.state.isReturnTrip &&
              <div className="flight__return">
                <h2 className="flight__number">{this.props.FlightData.airline}</h2>
                <h3 className="flight__number">{returnTrip.number.toUpperCase()}</h3>
                ...
                <p className="flight__depart__time">Departure time: {returnTrip.depart_time}</p>
                <p className="flight__arrive__time">Arrival time: {returnTrip.arrive_time}</p>
                <p className="flight__number">{returnTrip.price} TL </p>
              </div>
            }          
          </div>
        </div>
        <div className="flight__logo">
          <div className={`${this.props.FlightData.airline_code}`}></div>
          <button 
            className="booking--button"
            onClick={() => this.setState({bookingText: 'CONFIRMED'})}>
